...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/alvas2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/alvas1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/alvas.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/alvas3.jpg" alt="Flower">
        </div>
    </div>
</div>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> 4AL20CS149</h4>
                <h4><strong>Email:</strong> shamakulal10@gmail.com </h4>
                <h4><strong>Email: </strong>4al20cs149@gmail.com</h4>
            </div>
